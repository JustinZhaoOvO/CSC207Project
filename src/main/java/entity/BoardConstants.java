...
public class BoardConstants {
    ...
    public static final char WHITEKNIGHT = '♞';
    public static final char BLACKKNIGHT = '♘';
    public static final char WHITEBISHOP = '♝';
    public static final char BLACKBISHOP = '♗';
    public static final char WHITEQUEEN = '♛';
    public static final char BLACKQUEEN = '♕';
    public static final char WHITEKING = '♚';
    public static final char BLACKKING = '♔';
